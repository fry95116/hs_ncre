...
response.write "<script>alert('对不起，您的身份证号别人已经录入过了，请联系考点管理员！');history.back();</Script>"
response.end
End If
...
conn.close
set conn=nothing
response.write "<script>alert('恭喜您，资料修改成功！');location.href='change_info.asp';</Script>"
%>
