...
<span class="style3">*</span>
 <input name="xqkd" type="text" class="form" size="1" maxlength="1" value="<%=Trim(rscs("xq"))%>"  readonly="true" style="border:0;font-weight: bold;background:#f0f0f0;">
 <%if Trim(rscs("xq"))="1" then%>花园校区考点<%end if%> <%if Trim(rscs("xq"))="2" then%>龙子湖校区考点<%end if%>（不可更改）
