...
<table width="400" height="176" border="1" align="center" cellspacing="0">
              ...
              <td class="atd"><%if rs("xb")="1" then response.Write("1―男") else if rs("xb")="2" then response.Write("2―女")%>              </tr>
              <tr>
...
%></td>
              ...
              <tr>
                ...
                <td height="6" bgcolor="#F0F0F0" class="atd"><p align="left"><span class="tdc">保留成绩种类</span>： </td>
                <td height="6" class="atd"><%
