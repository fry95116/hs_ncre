        ...
        <td height="421" width="627" bgcolor="#F6F6F6" rowspan="4" valign="top"> 
          <div align="center">
            <table border="0" width="99%" cellspacing="1" height="369">
              <tr>
                <td height="40" colspan="2"><p align=center>修改报名资料，请谨慎修改，修改后请查看，<span class="STYLE3">*</span>为必填项!</td>
              </tr>
              <tr>
...
set rs0=nothing%>
              ...
              <tr>
			   ...
			   <TR>
           <td width="29%" height="24" bgcolor="#F0F0F0"><div align="right">报考校区考点： </div></td>
...
<select size=1  name="xqkd" class=form dataType="Require" msg="未选择校区考点">
            ...
            <option value="2" <%if rs("xq")="2" then%> selected  <%end if%>>2-龙子湖校区</option>
             </select> （选择考试校区）<td height="24">&nbsp;</td></tr>
        <TR>
              <tr>
...
set rs3=nothing%>
                ...
                <tr>
                <td width="29%" height="6" bgcolor="#F0F0F0"><p align="right"><span class="tdc">是否补考</span>： </td>
...
set rs4=nothing%>
			  ...
			  <tr>
                <td width="29%" height="6" bgcolor="#F0F0F0"><p align="right">单位或联系地址：                </td>
                <td width="68%" height="6"><span class="STYLE3">*</span><input type="text" name="addr1" size="20" maxlength="9" class="form" value="<%=rs("lxdz")%>"  dataType="Chinese"   msg="嵩山学院、软件学院、继续教育学院、国际教育学院学生及其他校外考生请填写所属单位名称或联系地址约为5-9个汉字，不要写数字"> 请填写联系地址或所属单位,5-9字为宜，不要填写数字 </td>
              </tr>
           <tr>
                <td width="29%" height="6" bgcolor="#F0F0F0"><p align="right">联系电话：                </td>
                <td width="68%" height="6"><span class="STYLE3">*</span><input type="text" name="tel1" datatype="Mobile" msg="请填写手机号码"  size="20" maxlength="20" class="form" value="<%=rs("lxdh")%>"  style="ime-mode: disabled;">                </td>
              </tr>
